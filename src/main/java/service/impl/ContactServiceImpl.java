...
public class ContactServiceImpl implements ContactService {
    ...
    public void editContact(Scanner scanner) {
        ...
        if (contact != null) {
            contactDao.editContact(editContactFields(contact, scanner));
            System.out.println("Thank you. Contact saved.");
            System.out.println();
        } else {
            System.out.println("Contact does not exist");
    ...
    public Contact editContactFields(Contact contact, Scanner scanner){
        ...
        contact = new Contact(contact.getId(),contact.getName(),contact.getSurName(),contact.getPhoneNumber());
